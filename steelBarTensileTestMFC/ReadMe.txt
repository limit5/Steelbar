================================================================================
    MFC (MICROSOFT FOUNDATION CLASS) ライブラリ : steelBarTensileTestMFC プロジェクトの概要
===============================================================================

この steelBarTensileTestMFC アプリケーションは、アプリケーション ウィザードによって作成されました。このアプリケーションは MFC の基本的な使い方を示すだけでなく、アプリケーションを作成するための開始点でもあります。

このファイルには、steelBarTensileTestMFC アプリケーションを構成する各ファイルの内容の概要が含まれています。

steelBarTensileTestMFC.vcxproj
...
steelBarTensileTestMFC.vcxproj.filters
...
steelBarTensileTestMFC.h
    これはアプリケーションのメイン ヘッダー ファイルです。
    その他のプロジェクト固有のヘッダー (Resource.h など) が含まれ、CsteelBarTensileTestMFCApp アプリケーション クラスを宣言します。

steelBarTensileTestMFC.cpp
    これはメインのアプリケーション ソース ファイルで、CsteelBarTensileTestMFCApp アプリケーション クラスが含まれています。

steelBarTensileTestMFC.rc
...
res\steelBarTensileTestMFC.ico
    これはアプリケーションのアイコンとして使用されるアイコン ファイルです。このアイコンは、メイン リソース ファイル steelBarTensileTestMFC.rc にインクルードされます。

res\steelBarTensileTestMFC.rc2
...
steelBarTensileTestMFCDlg.h, steelBarTensileTestMFCDlg.cpp - ダイアログ
    これらのファイルには、CsteelBarTensileTestMFCDlg クラスが含まれます。このクラスはアプリケーションのメイン ダイアログの動作を定義します。ダイアログのテンプレートは、Microsoft Visual C++ で編集できる steelBarTensileTestMFC.rc に含まれています。
...
StdAfx.h, StdAfx.cpp
    これらのファイルは、steelBarTensileTestMFC.pch という名前のプリコンパイル済みヘッダー (PCH) ファイルと、StdAfx.obj という名前のプリコンパイル済みの型ファイルをビルドするために使用されます。

Resource.h
    これは、新しいリソース ID を定義する標準のヘッダー ファイルです。このファイルの読み込みおよび更新は、Microsoft Visual C++ で行います。

steelBarTensileTestMFC.manifest
